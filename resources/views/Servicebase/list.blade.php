    ...
    <div class=" container-fluid  d-flex flex-stack flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
            ...
            <h1 class="text-dark fw-bold my-1 fs-2">
                Service Base <small class="text-muted fs-6 fw-normal ms-1"></small>
            </h1>
            <!--end::Title-->
            ...
            <ul class="breadcrumb fw-semibold fs-base my-1">
                <li class="breadcrumb-item text-muted">
                    <a href="" class="text-muted text-hover-primary">Service Base List</a>
                </li>
            </ul>
            <!--end::Breadcrumb-->
        </div>
                    ...
                    <tbody class="fw-semibold text-gray-600">
                        ...
                        @foreach ($arr as $key => $val)
                            <tr>
                                ...
                                <td>{{strtoupper($val->city)}}</td>
                                <td>{{strtoupper($val->region)}}</td>
                                <td>
                                    @if ($val->is_active == 1)
                                ...
                                <td>
                                    <div class="d-flex justify-content-center">
                                        <button type="button" class="btn btn-info me-3" data-name="edit_data" data-item="{{$val->id}},{{$val->city}}">
                                            Edit
                                        </button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body py-10 px-lg-17">
                ...
                <div class="d-flex flex-column mb-8 fv-row">
                    ...
                    <input type="text" class="form-control form-control-solid" placeholder="City" data-name="city"/>
                </div>
                ...
                <div class="d-flex flex-column mb-8 fv-row">
                    ...
                    <input type="text" class="form-control form-control-solid" placeholder="Region" data-name="region"/>
                </div>
...
<script>
    ...
    $(document).on("click", "[data-name='save_data']", function (e) {
        ...
        var city = $('[data-name="city"]').val();
        var region = $('[data-name="region"]').val();

        $.ajax({
            type: "POST",
            url: "{{ route('addservicebase') }}",
            data: {code:code,city:city,region:region},
            cache: false,
