...
<div id="kt_aside" class="aside aside-default  aside-hoverable " data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_toggle">
    ...
    <div class="aside-logo flex-column-auto px-10 pt-9 pb-5" id="kt_aside_logo">
        ...
        <a href="{{route('dashboard')}}">
            <img alt="Logo" src="{{asset('assets/plugin_tenp/logo.svg')}}" class="min-h-50px logo-default theme-light-show" />
            <img alt="Logo" src="{{asset('assets/plugin_tenp/logo.svg')}}" class="min-h-50px logo-default theme-dark-show" />
            <img alt="Logo" src="{{asset('assets/plugin_tenp/logo.svg')}}" class="min-h-50px logo-minimize" />
        </a>
        <!--end::Logo-->
    </div>
    <!--end::Brand-->
    ...
    <div class="aside-menu flex-column-fluid px-4 px-lg-7">
        ...
        <div class="menu menu-sub-indention menu-column menu-rounded menu-title-gray-600 menu-icon-gray-400 menu-active-bg menu-state-primary menu-arrow-gray-500 fw-semibold fs-6 my-5 mt-lg-2 mb-lg-0" id="kt_aside_menu" data-kt-menu="true">
            <div class="hover-scroll-y me-lg-n5 pe-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="20px" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer">
                ...
                <!--begin:Menu item-->
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion @if (Route::currentRouteName()=='betweenlatlong' || Route::currentRouteName()=='historybetweenlatlong') show @endif">
                    <!--begin:Menu link-->
                    <span class="menu-link">
                        ...
                        <span class="menu-title">Record Latlong</span>
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link @if (Route::currentRouteName()=='betweenlatlong') active @endif" href="{{route('betweenlatlong')}}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                                <span class="menu-title">Between Latlong</span>
                            </a>
                            <!--end:Menu link-->
                        </div>
                        <!--end:Menu item-->
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link @if (Route::currentRouteName()=='historybetweenlatlong') active @endif" href="{{route('historybetweenlatlong')}}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                ...
                <!--begin:Menu item-->
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion @if (Route::currentRouteName()=='formulir' || Route::currentRouteName()=='contenteform') show @endif">
                    <!--begin:Menu link-->
                    <span class="menu-link">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                        ...
                        <span class="menu-title">eForm</span>
                        <span class="menu-arrow"></span>
                    </span>
                    <!--end:Menu link-->
                    <!--begin:Menu sub-->
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        @if ($idn_user->role_id == '1')
                            ...
                            <div class="menu-item">
                                <!--begin:Menu link-->
                                <a class="menu-link @if (Route::currentRouteName()=='formulir') active @endif" href="{{route('formulir')}}">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                                    <span class="menu-title">List eForm</span>
                                </a>
                                <!--end:Menu link-->
                            </div>
                            <!--end:Menu item-->
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link @if (Route::currentRouteName()=='contenteform') active @endif" href="{{route('contenteform')}}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                                <span class="menu-title">Content eForm</span>
                            </a>
                            <!--end:Menu link-->
                        </div>
                        <!--end:Menu item-->
                ...
                @if ($idn_user->role_id == '1')
                    ...
                    <div class="menu-item">
                        ...
                        <a class="menu-link @if (Route::currentRouteName()=='project') active @endif" href="{{route('project')}}"><span class="menu-icon">
                            ...
                            <!--end::Svg Icon--></span><span class="menu-title">Project</span>
                        </a>
                        <!--end:Menu link-->
                    </div>
                    <!--end:Menu item-->
                    ...
                    <div class="menu-item">
                        <!--begin:Menu link-->
                        <a class="menu-link @if (Route::currentRouteName()=='entity') active @endif" href="{{route('entity')}}"><span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
                            <span class="svg-icon svg-icon-2">
                            ...
                            <!--end::Svg Icon--></span><span class="menu-title">Entity</span>
                        </a>
                        <!--end:Menu link-->
                    </div>
                    <!--end:Menu item-->
                        ...
                        <div class="menu-sub menu-sub-accordion">
                            ...
                            <div class="menu-item">
                                ...
                                <a class="menu-link @if (Route::currentRouteName()=='customertype') active @endif" href="{{route('customertype')}}">
                                    ...
                                    <span class="menu-title">Costumer Type</span>
                                </a>
                                <!--end:Menu link-->
                            </div>
                            <!--end:Menu item-->
                    ...
                    <!--begin:Menu item-->
                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion @if (Route::currentRouteName()=='machine' || Route::currentRouteName()=='machinetype' || Route::currentRouteName()=='machinevendor' || Route::currentRouteName()=='machinemodel') show @endif">
                        <!--begin:Menu link-->
                        <span class="menu-link">
                            <span class="menu-icon">
                                <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                        ...
                        <div class="menu-sub menu-sub-accordion">
                            ...
                            <div class="menu-item">
                                <!--begin:Menu link-->
                                <a class="menu-link @if (Route::currentRouteName()=='machinetype') active @endif" href="{{route('machinetype')}}">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                            ...
                            <div class="menu-item">
                                ...
                                <a class="menu-link @if (Route::currentRouteName()=='machinemodel') active @endif" href="{{route('machinemodel')}}">
                                    ...
                                    <span class="menu-title">Manage Model</span>
                                </a>
                                <!--end:Menu link-->
                            </div>
                            <!--end:Menu item-->
                    ...
                    <div class="menu-item">
                        <!--begin:Menu link-->
                        <a class="menu-link @if (Route::currentRouteName()=='servicebase') active @endif" href="{{route('servicebase')}}"><span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
                            <span class="svg-icon svg-icon-2">
                            ...
                            <!--end::Svg Icon--></span><span class="menu-title">Service Base</span>
                        </a>
                        <!--end:Menu link-->
                    </div>
                    <!--end:Menu item-->
