    ...
    <div class=" container-fluid  d-flex align-items-stretch justify-content-between">
        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
            ...
            <a href="" class="d-lg-none">
                <img alt="Logo" src="{{asset('assets/plugin_tenp/logo.svg')}}" class="mh-40px" />
            </a>
            <!--end::Logo-->
            ...
            <div class="d-flex align-items-stretch me-1">
                ...
                <div id="kt_header_search" class="header-search d-flex align-items-center w-100 w-lg-300px" data-kt-search-keypress="true" data-kt-search-min-length="2" data-kt-search-enter="enter" data-kt-search-layout="menu" data-kt-search-responsive="lg" data-kt-menu-trigger="auto" data-kt-menu-permanent="true" data-kt-menu-placement="bottom-start">
                    ...
                    <form data-kt-search-element="form"
                        ...
                        <!--begin::Svg Icon | path: icons/duotune/general/gen021.svg-->
                        <span
                            class="svg-icon search-icon  svg-icon-2 svg-icon-lg-3 svg-icon-gray-600 position-absolute top-50 translate-middle-y ms-5"><svg
                    ...
                    <div data-kt-search-element="content"
                        ...
                        <div data-kt-search-element="wrapper">
                                ...
                                <div class="scroll-y mh-200px mh-lg-350px">
                                    ...
                                    <a href="#"
                                        ...
                                        <div class="symbol symbol-40px me-4">
                                            <img src="https://preview.keenthemes.com/craft/assets/media/avatars/300-6.jpg" alt="" />
                                        </div>
                                        <!--end::Symbol-->
                                    ...
                                    <a href="#"
                                        ...
                                        <!--begin::Symbol-->
                                        <div class="symbol symbol-40px me-4">
                                            <img src="https://preview.keenthemes.com/craft/assets/media/avatars/300-2.jpg" alt="" />
                                        </div>
                                        <!--end::Symbol-->
                                    ...
                                    <a href="#"
                                        ...
                                        <!--begin::Symbol-->
                                        <div class="symbol symbol-40px me-4">
                                            <img src="https://preview.keenthemes.com/craft/assets/media/avatars/300-9.jpg" alt="" />
                                        </div>
                                        <!--end::Symbol-->
                                    ...
                                    <a href="#"
                                        ...
                                        <!--begin::Symbol-->
                                        <div class="symbol symbol-40px me-4">
                                            <img src="https://preview.keenthemes.com/craft/assets/media/avatars/300-14.jpg" alt="" />
                                        </div>
                                        <!--end::Symbol-->
                                    ...
                                    <a href="#"
                                        ...
                                        <!--begin::Symbol-->
                                        <div class="symbol symbol-40px me-4">
                                            <img src="https://preview.keenthemes.com/craft/assets/media/avatars/300-11.jpg" alt="" />
                                        </div>
                                        <!--end::Symbol-->
                                    ...
                                    <a href="#"
                                        ...
                                        <div class="symbol symbol-40px me-4">
                                            <span class="symbol-label bg-light">
                                                <img class="w-20px h-20px"
                                                    src="https://preview.keenthemes.com/craft/assets/media/svg/brand-logos/tvit.svg"
                                                    alt="" />
                                            </span>
                                        </div>
                                        <!--end::Symbol-->
                                    ...
                                    <a href="#"
                                        ...
                                        <div class="symbol symbol-40px me-4">
                                            <span class="symbol-label bg-light">
                                                <img class="w-20px h-20px"
                                                    src="https://preview.keenthemes.com/craft/assets/media/svg/misc/infography.svg"
                                                    alt="" />
                                            </span>
                                        </div>
                                        <!--end::Symbol-->
                            ...
                            <div data-kt-search-element="empty" class="text-center d-none">
                                ...
                                <div class="pt-10 pb-10">
                                    ...
                                    <span class="svg-icon svg-icon-4x opacity-50"><svg width="24"
                                            height="24" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path opacity="0.3"
                        ...
                        <form data-kt-search-element="advanced-options-form" class="pt-1 d-none">
                            ...
                            <div class="d-flex justify-content-end">
                                ...
                                <a href="https://preview.keenthemes.com/craft/pages/search/horizontal.html"
            ...
            <div class="d-flex align-items-stretch flex-shrink-0">
                ...
                <div class="d-flex align-items-center ms-2 ms-lg-3" id="kt_header_user_menu_toggle">
                    ...
                    <div class="cursor-pointer symbol symbol-35px symbol-lg-35px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                        <img alt="Pic" src="{{asset('assets/img/default.jpg')}}" />
                    </div>
